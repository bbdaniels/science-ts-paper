...
* Table 4. Main effect
	...
	* Period-wise
		...
		use "$datadir/Constructed/ts_lsoas.dta",clear 
			...
			xisto reg1 if time == 1, clear 	command(xtreg) depvar(capacity_day) cl(llsoa) fe ///
				rhs( shock total2 shock*social_ab shock*own_own shock*hh_flat shock*work_unemp shock*urban shock*density_hh )
			  
			xisto reg2 if time == 1,    	command(xtreg) depvar(income_day) cl(llsoa) fe ///
				rhs( shock total2 shock*social_ab shock*own_own shock*hh_flat shock*work_unemp shock*urban shock*density_hh)
			  
			xisto reg3 if time == 2,  	command(xtreg) depvar(capacity_day) cl(llsoa) fe ///
				rhs( shock total2 shock*social_ab shock*own_own shock*hh_flat shock*work_unemp shock*urban shock*density_hh)
			  
			xisto reg4 if time == 2,    	command(xtreg) depvar(income_day) cl(llsoa) fe ///
				rhs( shock total2 shock*social_ab shock*own_own shock*hh_flat shock*work_unemp shock*urban shock*density_hh)
			  
			xisto reg5 if time == 3,  	command(xtreg) depvar(capacity_day) cl(llsoa) fe ///
				rhs( shock total2 shock*social_ab shock*own_own shock*hh_flat shock*work_unemp shock*urban shock*density_hh)
			  
			xisto reg6 if time == 3,    	command(xtreg) depvar(income_day) cl(llsoa) fe ///
				rhs( shock total2 shock*social_ab shock*own_own shock*hh_flat shock*work_unemp shock*urban shock*density_hh)
