* Make analysis datasets
	...
	* Installs
      ...
      replace shock = 1 if (date > 19251 & date <= 19297) ///
      | (date >= date("Mar 3, 2013","MDY") & date < date("Jul 1, 2013","MDY")) ///
      | (date >= date("Oct 1, 2013","MDY") & date < date("Jan 1, 2014","MDY")) ///
      | (date >= date("Feb 15, 2014","MDY") & date < date("Apr 1, 2014","MDY")) ///
      | (date >= date("Aug 17, 2014","MDY") & date < date("Jan 1, 2015","MDY")) ///
      | (date >= date("Feb 15, 2015","MDY") & date < date("Apr 1, 2015","MDY")) ///
      | (date >= date("May 17, 2015","MDY"))
